...
<jsp:include page="/template/header.jsp">
	...
	<jsp:param name="topMenu" value="<%= Menus.stats(TournamentFactory._2001()).asTopLevel().output(request, \"home\") %>" />
...
<div class="row">
	<div class="small-12 columns">
		...
		<section id="category">
			...
			<h3>Chemistry</h3>
			<p>The following numbers are guesses. The relative rankings are correct. It's possible that Jim et&nbsp;al actually answered seven, Parag and Alex answered six, and Paras et&nbsp;al answered five (but that would mean no one answered exactly four correctly, which seems unlikely).</p>
			<dl>
				<dt>Six tossups</dt>
			...
			<p>The following numbers are guesses. The relative rankings are correct. It's possible that Matt et&nbsp;al actually answered seven, Paras et&nbsp;al answered six, and Greg et&nbsp;al answered five (but that would mean no one answered exactly four correctly, which seems unlikely).</p>
			<dl>
				<dt>Six tossups</dt>
					<dd>Matt Abbott, Fremd</dd>
					<dd>Parag Bhayani, Homewood-Flossmoor</dd>
			...
			<p>The following numbers are guesses. The relative rankings are correct. It's possible that Matt et&nbsp;al actually answered seven, Denny et&nbsp;al answered six, and Paul et&nbsp;al answered five (but that would mean no one answered exactly four correctly, which seems unlikely).</p>
			<dl>
				<dt>Six tossups</dt>
					<dd>Matt Keenan, New Trier</dd>
					<dd>Ben Taylor, Guilford</dd>
			...
			<h3>Language Arts</h3>
			<p>The following numbers are guesses. The relative rankings are correct. It's possible that John actually answered seven, Jim et&nbsp;al answered six, and Denny et&nbsp;al answered five (but that would mean no one answered exactly four correctly, which seems unlikely).</p>
			<dl>
				<dt>Six tossups</dt>
					<dd>John Keig, Moline</dd>
				<dt>Five tossups</dt>
			...
			<h3>Music</h3>
			<p>The following numbers are guesses. The relative rankings are correct. It's possible that Jim et&nbsp;al actually answered seven, Parag et&nbsp;al answered six, and Dena et&nbsp;al answered five (but that would mean no one answered exactly four correctly, which seems unlikely).</p>
			<dl>
				<dt>Six tossups</dt>
					<dd>Jim Davis, Latin</dd>
					<dd>Donnie Norton, Macomb</dd>
			...
			<h3>Nonfiction</h3>
			<p>The following numbers are guesses. The relative rankings are correct. It's possible that Jim actually answered seven, Matt et&nbsp;al answered six, and Denny et&nbsp;al answered five (but that would mean no one answered exactly four correctly, which seems unlikely).</p>
			<dl>
				<dt>Six tossups</dt>
					<dd>Jim Davis, Latin</dd>
				<dt>Five tossups</dt>
			...
			<p>The following numbers are guesses. The relative rankings are correct. It's possible that Mark actually answered seven, Jim and Kelly answered six, and Parag et&nbsp;al answered five (but that would mean no one answered exactly four correctly, which seems unlikely).</p>
			<dl>
				<dt>Six tossups</dt>
					<dd>Mark Pliska, Fremd</dd>
				<dt>Five tossups</dt>
