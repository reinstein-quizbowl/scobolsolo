...
<jsp:include page="/template/header.jsp">
	...
	<jsp:param name="topMenu" value="<%= Menus.stats(TournamentFactory._2013()).asTopLevel().output(request, \"home\") %>" />
...
<div class="row">
	<div class="small-12 columns">
		...
		<p>The full <a href="/stats/standings.jsp?object=2013">preliminary results</a> are available.</p>
	</div>
</div>
