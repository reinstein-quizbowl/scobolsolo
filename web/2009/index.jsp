...
<jsp:include page="/template/header.jsp">
	...
	<jsp:param name="topMenu" value="<%= Menus.stats(TournamentFactory._2009()).asTopLevel().output(request, \"home\") %>" />
		...
		<table class="tournament-final-standings">
			...
			<tbody>
				...
				<tr>
					...
					<td class="school">St.&nbsp;Ignatius (Chicago)</td>
					<td class="note">&nbsp;</td>
				</tr>
				<tr>
					<th class="rank">3.</th>
				...
				<tr>
					...
					<td class="school">Oak Park-River Forest</td></td>
					<td class="note">&nbsp;</td>
				</tr>
				<tr>
					<th class="rank">&nbsp;</th>
