		...
		%><%= lclNewWEOF.open() %>
			<div class="row">
				<div class="small-12 medium-6 large-3 columns">
					<label>
						School
						<%= lclNewWEOF.dropdown("SchoolRegistration", SchoolRegistration.SchoolShortNameComparator.getInstance()).filter(new SchoolRegistrationRegisteredFor(lclT)).namer(SchoolRegistrationNCE.getInstance()) %>
					</label>
				</div>
