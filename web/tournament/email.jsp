	...
	<section>
		...
		<div class="row">
			<div class="small-12 medium-6 columns">
				<label>
					From address
					<input type="text" name="from" id="from" value="admin@reinsteinquizbowl.com" required />
					<p class="help-text">must end in reinsteinquizbowl.com or jonahgreenthal.com</p>
				</label>
			</div>
			<div class="small-12 medium-6 columns">
				<label>
