...
/**
 * represents a <code>WaitlistEntry</code> from the persistent store
 *
 * <p>This interface was automatically generated to represent objects loaded from the database table <code>waitlist_entry</code>.  Do not modify this class directly; instead, alter the database table on which it is based and/or the Opal configuration file for the project and then regenerate the opals.  Any changes made to this file will be lost if the opals are regenerated.</p>
 *
 * <p>To create objects of this type from persistent data, use one of the various <code>forXXX</code> methods on the {@link WaitlistEntryFactory} factory class.  To create new instances, use the <code>create()</code> method on the factory.</p>
 *
 ...
 *
 * <p>This interface and the {@link WaitlistEntryFactory} class (the ones in the <code>com.scobolsolo.application</code> package) are the only two automatically generated files for the table that are intended to be referenced in user code. Other automatically generated files (namely those in the <code>com.scobolsolo.persistence</code> package) are intended to be invisible to the user's code and may change (or disappear entirely) when newer versions of the Opal generating code is used.</p>
 *
 * @author		<a href="mailto:jonah@jonahgreenthal.com">Jonah Greenthal</a>
 */
public interface WaitlistEntry extends IdentityUserFacing, Comparable<WaitlistEntry> {
	/* Accessors and mutators for internal data. */
	/**
	 * object accessor for the Id
	 *
	 * <p>The Id field is a direct mapping of the <code>id</code> database column in the table <code>waitlist_entry</code>.</p>
	 *
	 ...
	 *
	 * <p>The SchoolRegistrationId field is a direct mapping of the <code>school_registration_id</code> database column in the table <code>waitlist_entry</code>.</p>
	 *
	 ...
	 *
	 * <p>The Sequence field is a direct mapping of the <code>sequence</code> database column in the table <code>waitlist_entry</code>.</p>
	 *
	 ...
	 *
	 * <p>The PlayerCount field is a direct mapping of the <code>player_count</code> database column in the table <code>waitlist_entry</code>.</p>
	 *
	 ...
	 *
	 * <p>The Note field is a direct mapping of the <code>note</code> database column in the table <code>waitlist_entry</code>.</p>
	 *
	 ...
	 * The returned <code>SchoolRegistration</code> is the {@link UserFacing} object corresponding to the row in the <code>school_registration</code> that is referenced by the foreign key <code>waitlist_entry_school_registration_id_fkey</code>.
	 *
	 */
	...
	/** This is a Comparator that can be used to compare WaitlistEntry objects based on their Id values. */

	public static class IdComparator extends com.siliconage.util.NullSafeComparator<WaitlistEntry> {
		...
		@Override
		public int compareInternal(WaitlistEntry argFirst, WaitlistEntry argSecond) {
			return argFirst.getIdAsObject().compareTo(argSecond.getIdAsObject());
		}
	}

	/** This is a Comparator that can be used to compare WaitlistEntry objects based on their Sequence values. */

	public static class SequenceComparator extends com.siliconage.util.NullSafeComparator<WaitlistEntry> {
