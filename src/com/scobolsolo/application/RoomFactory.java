...
public class RoomFactory extends com.opal.AbstractIdentityFactory<Room, RoomOpal> implements com.opal.FactoryCreator<Room> {
	...
	*/
	...
	protected RoomFactory(com.opal.IdentityOpalFactory<Room, RoomOpal> argOpalFactory) {
