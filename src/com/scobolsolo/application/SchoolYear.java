...
/**
 * represents a <code>SchoolYear</code> from the persistent store
 *
 * <p>This interface was automatically generated to represent objects loaded from the database table <code>school_year</code>.  Do not modify this class directly; instead, alter the database table on which it is based and/or the Opal configuration file for the project and then regenerate the opals.  Any changes made to this file will be lost if the opals are regenerated.</p>
 *
 * <p>To create objects of this type from persistent data, use one of the various <code>forXXX</code> methods on the {@link SchoolYearFactory} factory class.  To create new instances, use the <code>create()</code> method on the factory.</p>
 *
...
public interface SchoolYear extends IdentityUserFacing, Comparable<SchoolYear> {
	 ...
	 *
	 * <p>The Name field is a direct mapping of the <code>name</code> database column in the table <code>school_year</code>.</p>
	 *
	 ...
	 *
	 * <p>The ShortName field is a direct mapping of the <code>short_name</code> database column in the table <code>school_year</code>.</p>
	 *
	 ...
	 *
	 * <p>The VeryShortName field is a direct mapping of the <code>very_short_name</code> database column in the table <code>school_year</code>.</p>
	 *
	 ...
	 *
	 * <p>The Sequence field is a direct mapping of the <code>sequence</code> database column in the table <code>school_year</code>.</p>
	 *
	...
	/** This is a Comparator that can be used to compare SchoolYear objects based on their Code values. */

	public static class CodeComparator extends com.siliconage.util.NullSafeComparator<SchoolYear> {
		...
		@Override
		public int compareInternal(SchoolYear argFirst, SchoolYear argSecond) {
			return argFirst.getCode().compareToIgnoreCase(argSecond.getCode());
		}
	}

	/** This is a Comparator that can be used to compare SchoolYear objects based on their Name values. */

	public static class NameComparator extends com.siliconage.util.NullSafeComparator<SchoolYear> {
	...
	/** This is a Comparator that can be used to compare SchoolYear objects based on their ShortName values. */

	public static class ShortNameComparator extends com.siliconage.util.NullSafeComparator<SchoolYear> {
	...
	/** This is a Comparator that can be used to compare SchoolYear objects based on their VeryShortName values. */

	public static class VeryShortNameComparator extends com.siliconage.util.NullSafeComparator<SchoolYear> {
	...
	/** This is a Comparator that can be used to compare SchoolYear objects based on their Sequence values. */

	public static class SequenceComparator extends com.siliconage.util.NullSafeComparator<SchoolYear> {
