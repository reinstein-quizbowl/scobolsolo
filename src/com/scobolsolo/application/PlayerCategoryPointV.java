...
/**
 * represents a <code>PlayerCategoryPointV</code> from the persistent store
 *
 * <p>This interface was automatically generated to represent objects loaded from the database table <code>player_category_point_v</code>.  Do not modify this class directly; instead, alter the database table on which it is based and/or the Opal configuration file for the project and then regenerate the opals.  Any changes made to this file will be lost if the opals are regenerated.</p>
 *
 * <p>To create objects of this type from persistent data, use one of the various <code>forXXX</code> methods on the {@link PlayerCategoryPointVFactory} factory class.  To create new instances, use the <code>create()</code> method on the factory.</p>
 *
 ...
 *
 * <p>This interface and the {@link PlayerCategoryPointVFactory} class (the ones in the <code>com.scobolsolo.application</code> package) are the only two automatically generated files for the table that are intended to be referenced in user code. Other automatically generated files (namely those in the <code>com.scobolsolo.persistence</code> package) are intended to be invisible to the user's code and may change (or disappear entirely) when newer versions of the Opal generating code is used.</p>
 *
 * @author		<a href="mailto:jonah@jonahgreenthal.com">Jonah Greenthal</a>
 */
public interface PlayerCategoryPointV extends UserFacing {
	/* Accessors and mutators for internal data. */
	/**
	 * object accessor for the TournamentCode
	 *
	 * <p>The TournamentCode field is a direct mapping of the <code>tournament_code</code> database column in the table <code>player_category_point_v</code>.</p>
	 *
	 ...
	 *
	 * <p>The PlayerId field is a direct mapping of the <code>player_id</code> database column in the table <code>player_category_point_v</code>.</p>
	 *
	 ...
	 *
	 * <p>The CategoryCode field is a direct mapping of the <code>category_code</code> database column in the table <code>player_category_point_v</code>.</p>
	 *
	 ...
	 *
	 * <p>The TossupsHeard field is a direct mapping of the <code>tossups_heard</code> database column in the table <code>player_category_point_v</code>.</p>
	 *
	 ...
	 *
	 * <p>The Points field is a direct mapping of the <code>points</code> database column in the table <code>player_category_point_v</code>.</p>
	 *
	...
	default public double getPPTUH() {
		return com.scobolsolo.application.PlayerCategoryPointVDelegate.getPPTUH(this);
	}

	public static class CategoryComparator extends com.siliconage.util.NullSafeComparator<PlayerCategoryPointV> {
		...
		@Override
		public int compareInternal(PlayerCategoryPointV argFirst, PlayerCategoryPointV argSecond) {
