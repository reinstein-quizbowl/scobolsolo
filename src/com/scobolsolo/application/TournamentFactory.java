...
public class TournamentFactory extends com.opal.AbstractIdentityFactory<Tournament, TournamentOpal> implements com.opal.FactoryCreator<Tournament> {
	...
	*/
	...
	protected TournamentFactory(com.opal.IdentityOpalFactory<Tournament, TournamentOpal> argOpalFactory) {
	...
	*/
	...
	public static final Tournament _2018() { return getInstance().forCode("2018"); }
	public static final Tournament _2019() { return getInstance().forCode("2019"); }
	public static final Tournament _2020() { return getInstance().forCode("2020"); }
	public static final Tournament _2021() { return getInstance().forCode("2021"); }
	public static final Tournament _2022() { return getInstance().forCode("2022"); }
