...
import com.scobolsolo.paperwork.ChampionshipRulesOutputter;
import com.scobolsolo.paperwork.LaTeXCompiler;
import com.scobolsolo.paperwork.LaTeXOutputter;
import com.scobolsolo.paperwork.MasterByCardOutputter;
import com.scobolsolo.paperwork.MasterByRoomOutputter;
import com.scobolsolo.paperwork.PlayerCardOutputter;
import com.scobolsolo.paperwork.PlayerWelcomeSheetOutputter;
import com.scobolsolo.paperwork.ReplacementGuideOutputter;
import com.scobolsolo.paperwork.RoomCardOutputter;
import com.scobolsolo.paperwork.SchoolWelcomeSheetOutputter;
import com.scobolsolo.paperwork.ScoresheetOutputter;
import com.scobolsolo.paperwork.StaffWelcomeSheetOutputter;
	...
	protected Download makeDownload(final HttpServletRequest argRequest, final Account argUser) {
		...
		for (Phase lclP : lclT.createPhaseArray()) {
			...
			if (ControllerServlet.getBooleanParameter(argRequest, "scoresheets_" + lclP.getId())) {
				lclOutputters.add(new ScoresheetOutputter(new File(DIRECTORY + lclPhaseSpecificBaseFilename + "scoresheets.tex"), lclP));
			}
		}
