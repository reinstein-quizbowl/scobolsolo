...
public interface PhaseUserFacing extends IdentityUserFacing, Comparable<com.scobolsolo.application.Phase> {
	 ...
	 * The returned {@code com.scobolsolo.application.Tournament} is the {@link UserFacing} object corresponding to the entry in {@code tournament} that is referenced by {@code phase_tournament_code_fkey}.
	 *
	 */
