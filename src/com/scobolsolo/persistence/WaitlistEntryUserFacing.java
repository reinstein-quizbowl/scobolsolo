...
/**
 * represents a {@code WaitlistEntry} from the persistent store
 *
 * <p>This interface was automatically generated to represent objects loaded from {@code waitlist_entry}.  Do not modify this class directly; instead, alter the permanent storage on which it is based, the Opal configuration file for the project, and/or the {@link com.scobolsolo.application.WaitlistEntry}, and then regenerate the opals.  Any changes made to this file will be lost if the opals are regenerated.</p>
 *
 * <p>To create objects of this type from persistent data, use one of the various {@code forXXX} methods on the {@link com.scobolsolo.application.WaitlistEntryFactory} factory class.  To create new instances, use the {@code create()} method on the factory.</p>
 *
 * <p>Objects that implement this interface must provide Opal thread semantics; among other things this means that all modification of such objects must be done with an active {@link com.opal.TransactionContext}.</p>
 *
 * <p>This interface is not meant to be referenced in user code.  Only the {@link com.scobolsolo.application.WaitlistEntry} and the {@link com.scobolsolo.application.WaitlistEntryFactory} class should be referenced directly.</p>
 *
 * @author		<a href="mailto:jonah@jonahgreenthal.com">Jonah Greenthal</a>
 */
public interface WaitlistEntryUserFacing extends com.opal.IdentityUserFacing, Comparable<com.scobolsolo.application.WaitlistEntry> {

	/* Accessors and mutators for internal data. */
	/**
	 * object accessor for the {@code Id}
	 *
	 * <p>The {@code Id} field is a direct mapping of the {@code id} field in {@code waitlist_entry}.</p>
	 *
	 ...
	 *
	 * <p>The {@code Id} field is a direct mapping of the {@code id} database column in the table {@code waitlist_entry}.</p>
	 *
	 ...
	 *
	 * <p>The {@code SchoolRegistrationId} field is a direct mapping of the {@code school_registration_id} field in {@code waitlist_entry}.</p>
	 *
	 ...
	 *
	 * <p>The {@code SchoolRegistrationId} field is a direct mapping of the {@code school_registration_id} database column in the table {@code waitlist_entry}.</p>
	 *
	 ...
	 *
	 * <p>The {@code Sequence} field is a direct mapping of the {@code sequence} field in {@code waitlist_entry}.</p>
	 *
	 ...
	 *
	 * <p>The {@code Sequence} field is a direct mapping of the {@code sequence} database column in the table {@code waitlist_entry}.</p>
	 *
	 ...
	 *
	 * <p>The {@code PlayerCount} field is a direct mapping of the {@code player_count} field in {@code waitlist_entry}.</p>
	 *
	 ...
	 *
	 * <p>The {@code PlayerCount} field is a direct mapping of the {@code player_count} database column in the table {@code waitlist_entry}.</p>
	 *
	 ...
	 *
	 * <p>The {@code Note} field is a direct mapping of the {@code note} field in {@code waitlist_entry}.</p>
	 *
	 ...
	 *
	 * <p>The {@code Note} field is a direct mapping of the {@code note} database column in the table {@code waitlist_entry}.</p>
	 *
	 ...
	 * The returned {@code com.scobolsolo.application.SchoolRegistration} is the {@link com.opal.UserFacing} object corresponding to the entry in {@code school_registration} that is referenced by {@code waitlist_entry_school_registration_id_fkey}.
	 *
	 */
	@com.opal.annotation.Nullability(nullable = false)
	...
	/** This is a Comparator that can be used to compare WaitlistEntry objects based on their {@code Id} values. */

	public static class IdComparator extends com.siliconage.util.NullSafeComparator<com.scobolsolo.application.WaitlistEntry> {
		...
		@Override
		public int compareInternal(com.scobolsolo.application.WaitlistEntry argFirst, com.scobolsolo.application.WaitlistEntry argSecond) {
			return argFirst.getIdAsObject().compareTo(argSecond.getIdAsObject());
		}
	}

	/** This is a Comparator that can be used to compare WaitlistEntry objects based on their {@code Sequence} values. */

	public static class SequenceComparator extends com.siliconage.util.NullSafeComparator<com.scobolsolo.application.WaitlistEntry> {
