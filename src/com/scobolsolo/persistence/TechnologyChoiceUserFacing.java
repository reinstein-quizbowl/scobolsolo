...
/**
 * represents a {@code TechnologyChoice} from the persistent store
 *
 * <p>This interface was automatically generated to represent objects loaded from {@code technology_choice}.  Do not modify this class directly; instead, alter the permanent storage on which it is based, the Opal configuration file for the project, and/or the {@link com.scobolsolo.application.TechnologyChoice}, and then regenerate the opals.  Any changes made to this file will be lost if the opals are regenerated.</p>
 *
 * <p>To create objects of this type from persistent data, use one of the various {@code forXXX} methods on the {@link com.scobolsolo.application.TechnologyChoiceFactory} factory class.  To create new instances, use the {@code create()} method on the factory.</p>
 *
 * <p>Objects that implement this interface must provide Opal thread semantics; among other things this means that all modification of such objects must be done with an active {@link com.opal.TransactionContext}.</p>
 *
 * <p>This interface is not meant to be referenced in user code.  Only the {@link com.scobolsolo.application.TechnologyChoice} and the {@link com.scobolsolo.application.TechnologyChoiceFactory} class should be referenced directly.</p>
 *
...
public interface TechnologyChoiceUserFacing extends com.opal.IdentityUserFacing, Comparable<com.scobolsolo.application.TechnologyChoice> {
	 ...
	 *
	 * <p>The {@code Code} field is a direct mapping of the {@code code} field in {@code technology_choice}.</p>
	 *
	 ...
	 *
	 * <p>The {@code Name} field is a direct mapping of the {@code name} field in {@code technology_choice}.</p>
	 *
	 ...
	 *
	 * <p>The {@code ShortName} field is a direct mapping of the {@code short_name} field in {@code technology_choice}.</p>
	 *
	 ...
	 *
	 * <p>The {@code VeryShortName} field is a direct mapping of the {@code very_short_name} field in {@code technology_choice}.</p>
	 *
	 ...
	 *
	 * <p>The {@code Sequence} field is a direct mapping of the {@code sequence} field in {@code technology_choice}.</p>
	 *
	 ...
	 *
	 * <p>The {@code Sequence} field is a direct mapping of the {@code sequence} database column in the table {@code technology_choice}.</p>
	 *
	...
	/**
	 * object accessor for the {@code Computer}
	 *
	 * <p>The {@code Computer} field is a direct mapping of the {@code has_computer} field in {@code technology_choice}.</p>
	 *
	 * <p>This method returns the current value as an Object.  To retrieve the value as a primitive, use the hasComputer() method.</p>
	 *
	...
	/**
	 * primitive accessor for the {@code Computer}
	 *
	 * <p>The {@code Computer} field is a direct mapping of the {@code has_computer} database column in the table {@code technology_choice}.</p>
	 *
	 * <p>This method returns the value as a primitive (for example, as an {@code int} rather than an {@code Integer}; to retrieve the value as an object, use the hasComputerAsObject() method.</p>
	 *
	 * @return the primitive value of {@code Computer} (of the current {@link com.opal.TransactionContext})
	 */
	default public boolean hasComputer() {
		java.lang.Boolean lclO = hasComputerAsObject();
		return lclO.booleanValue();
	}

	/**
	 * sets the {@code Computer} to the value of {@code argComputer}
	 *
	 * @param argComputer the new value of {@code Computer}.  May not be <code>null</code>.
	 * @return itself, so that mutator calls can be chained fluently
	 * <p>The database column {@code has_computer} to which this field is mapped is {@code NOT NULL}.</p>
	 *
	...
	/** This is a Comparator that can be used to compare TechnologyChoice objects based on their {@code Code} values. */

	public static class CodeComparator extends com.siliconage.util.NullSafeComparator<com.scobolsolo.application.TechnologyChoice> {
		...
		@Override
		public int compareInternal(com.scobolsolo.application.TechnologyChoice argFirst, com.scobolsolo.application.TechnologyChoice argSecond) {
			return argFirst.getCode().compareToIgnoreCase(argSecond.getCode());
		}
	}

	/** This is a Comparator that can be used to compare TechnologyChoice objects based on their {@code Name} values. */

	public static class NameComparator extends com.siliconage.util.NullSafeComparator<com.scobolsolo.application.TechnologyChoice> {
	...
	/** This is a Comparator that can be used to compare TechnologyChoice objects based on their {@code ShortName} values. */

	public static class ShortNameComparator extends com.siliconage.util.NullSafeComparator<com.scobolsolo.application.TechnologyChoice> {
	...
	/** This is a Comparator that can be used to compare TechnologyChoice objects based on their {@code VeryShortName} values. */

	public static class VeryShortNameComparator extends com.siliconage.util.NullSafeComparator<com.scobolsolo.application.TechnologyChoice> {
	...
	/** This is a Comparator that can be used to compare TechnologyChoice objects based on their {@code Sequence} values. */

	public static class SequenceComparator extends com.siliconage.util.NullSafeComparator<com.scobolsolo.application.TechnologyChoice> {
