...
public class PostgresStandbyEntryOpalFactory extends com.opal.AbstractDatabaseIdentityOpalFactory<StandbyEntry, StandbyEntryOpal> implements StandbyEntryOpalFactory {
	...
	@Override
	protected void processGeneratedKeys(java.sql.ResultSet argRS, StandbyEntryOpal argOpal) {
		try {
	...
	protected void registerOpal(StandbyEntryOpal argOpal, Object[] argValues) {
		...
		OpalCache<StandbyEntryOpal> lclOC = getCache();
		synchronized (lclOC) {
	...
	/* package */ static class IdOpalKey extends com.opal.SingleValueDatabaseOpalKey<StandbyEntryOpal> {
