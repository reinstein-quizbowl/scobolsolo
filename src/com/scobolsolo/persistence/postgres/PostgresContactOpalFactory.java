...
import com.scobolsolo.persistence.ContactImpl;
...
public class PostgresContactOpalFactory extends com.opal.AbstractDatabaseIdentityOpalFactory<Contact, ContactOpal> implements ContactOpalFactory {
	...
	@Override
	protected void processGeneratedKeys(java.sql.ResultSet argRS, ContactOpal argOpal) {
		try {
	...
	protected void registerOpal(ContactOpal argOpal, Object[] argValues) {
		...
		OpalCache<ContactOpal> lclOC = getCache();
		synchronized (lclOC) {
	...
	/* package */ static class IdOpalKey extends com.opal.SingleValueDatabaseOpalKey<ContactOpal> {
